...
const LoginPage = () => {
  ...
  // }
    ...
    try {
      ...
      const response = await axios.post("http://localhost:5000/student/login", {email, password},{ withCredentials: true } );
  ...
  return (
    ...
    <div className="head1"><p1>Innovative learning for a modern world.</p1></div>
    <div className="head2"><Link className="learn" to="#"><p1>Learn more</p1></Link></div>
      ...
      <div className="login-form">
        <form onSubmit={handleUserLogin}>
          ...
          <Link to="/adminlogin"><button className="first">Admin</button></Link>
